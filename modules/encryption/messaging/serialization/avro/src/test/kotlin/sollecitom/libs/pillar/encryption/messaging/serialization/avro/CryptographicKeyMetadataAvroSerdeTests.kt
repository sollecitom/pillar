...
class CryptographicKeyMetadataAvroSerdeTests : AcmeAvroSerdeTestSpecification<CryptographicKey.Metadata>, CoreDataGenerator by CoreDataGenerator.testProvider, CryptographicKeyGenerator {

    override val cryptographicOperations: CryptographicOperations = CryptographicOperations.bouncyCastle(secureRandom)
    override val avroSerde = CryptographicKey.Metadata.avroSerde

    override fun parameterizedArguments() = listOf(
        "AES_256" to newAesKey(variant = AES.Variant.AES_256).metadata
    )
}